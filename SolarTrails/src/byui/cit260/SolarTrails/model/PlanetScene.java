 ...
 * @author Kyle
 */
public class PlanetScene implements Serializable{
    ...
    public String toString() {
        return "PlanetScene{" + "description=" + description + ", travelTime=" + travelTime + ", symbol=" + symbol + ", availableActions=" + availableActions + '}';
    }
    ...
    public boolean equals(Object obj) {
        ...
        final PlanetScene other = (PlanetScene) obj;
